...
books=pd.read_csv(r'C:\Users\YASH\Desktop\pandas\Books.csv')
        ...
        if user_input:
                ...
                if recommended_books:
                    ...
                    for idx, book in enumerate(recommended_books):
                            cols[idx].write(f"Title: {book[0]}, Author: {book[1]}")
                            cols[idx].image(book[2], caption=book[0], use_column_width=False, width=100)
                else:
