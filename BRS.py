...
gdown.download('https://drive.google.com/file/d/1FTdhU53zkVtblEfynWFvN4-jXdUzp9Q7/view?usp=drive_link', 'Ratings.csv', quiet=False)
ratings = pd.read_csv('Ratings.csv')

gdown.download('https://drive.google.com/file/d/1ZKd2phRixAp51mRMVCqV03wdQNwuOldo/view?usp=drive_link', 'Users.csv', quiet=False)
